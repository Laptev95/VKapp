...
using vkApp.Model;
using vkApp.Services.Media.Core;
...
namespace vkApp.Services.Media
{
    public static class AudioService
    {
        ...
        private static void MediaPlayerOnMediaFailed(object sender, Exception e)
        {
            ...
            if (e is InvalidWmpVersionException)
            {
                ...
                flyout.FlyoutContent = new CommonMessageView() { Header = "Audio Failed Error", Message = "Wmp Missing Error" };
                flyout.Show();
                return;
            }
